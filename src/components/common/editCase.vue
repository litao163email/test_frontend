<template>
	<el-scrollbar height="calc(100vh - 60px);">
		...
		<el-row :gutter="10">
			...
			<el-col :span="6" style="text-align: right;"><el-button @click="runCase" type="primary" icon="el-icon-s-promotion">Run</el-button></el-col>
		</el-row>
		<div class="case_info" v-if="caseInfo.id">
			...
			<el-row>
				...
				<el-col :span="12" style="text-align: right;">
					...
					<el-button v-if='$route.path==="/testStep"' @click="copyCase" type="primary" icon="el-icon-document-copy" plain>复制</el-button>
					<el-button @click="saveCase" type="primary" icon="el-icon-s-claim" plain>保存</el-button>
				</el-col>
			</el-row>
		</div>
			...
			<el-tab-pane label="前置脚本">
				<el-row :gutter="10">
					...
					<el-col :span="6">
						...
						<div class="code_mod"><el-button type="primary" size="mini" plain @click="addSetUptCodeMod('ENV')">预设全局变量</el-button></div>
						<div class="code_mod"><el-button type="primary" size="mini" plain @click="addSetUptCodeMod('env')">预设局部变量</el-button></div>
						<div class="code_mod"><el-button type="primary" size="mini" plain @click="addSetUptCodeMod('func')">调用全局函数</el-button></div>
						<div class="code_mod"><el-button type="primary" size="mini" plain @click="addSetUptCodeMod('sql')">执行sql查询</el-button></div>
					</el-col>
				</el-row>
			</el-tab-pane>
				...
				<el-row :gutter="10">
					...
					<el-col :span="6">
						...
						<el-scrollbar height="250px">
							<div class="code_mod"><el-button type="primary" size="mini" plain @click="addTearDownCodeMod('getBody')">获取响应体</el-button></div>
							<div class="code_mod"><el-button type="primary" size="mini" plain @click="addTearDownCodeMod('JSextract')">jsonpath提取数据</el-button></div>
							<div class="code_mod"><el-button type="primary" size="mini" plain @click="addTearDownCodeMod('REextract')">正则提取数据</el-button></div>
							<div class="code_mod"><el-button type="primary" size="mini" plain @click="addTearDownCodeMod('ENV')">设置全局变量</el-button></div>
							<div class="code_mod"><el-button type="primary" size="mini" plain @click="addTearDownCodeMod('env')">设置局部变量</el-button></div>
							<div class="code_mod"><el-button type="primary" size="mini" plain @click="addTearDownCodeMod('func')">调用全局函数</el-button></div>
							<div class="code_mod"><el-button type="primary" size="mini" plain @click="addTearDownCodeMod('sql')">执行sql查询</el-button></div>
							<div class="code_mod"><el-button type="primary" size="mini" plain @click="addTearDownCodeMod('http')">断言HTTP状态码</el-button></div>
							<div class="code_mod"><el-button type="primary" size="mini" plain @click="addTearDownCodeMod('eq')">断言相对</el-button></div>
							<div class="code_mod"><el-button type="primary" size="mini" plain @click="addTearDownCodeMod('contain')">断言包含</el-button></div>
						</el-scrollbar>
					</el-col>
				</el-row>
			</el-tab-pane>
	...
	data() {
		return {
			caseInfo: {
				...
				title: '接口调试',
				headers: {},
				request: { json: { pwd: 'lemonban', mobile_phone: '18989829898' } },
				file: [],
				setup_script: '',
				teardown_script: ''
			},
