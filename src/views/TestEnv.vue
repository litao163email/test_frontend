<template>
	<el-row :gutter="10">
		<el-col :span="4">
			<div class="data_box">
				<div class="title">测试环境</div>
				<el-button @click="addEnv" type="primary" plain size="mini" style="width: 100%;" icon="el-icon-plus">创建测试环境</el-button>
		...
		<el-col :span="8" v-if="EnvInfo">
			<el-scrollbar height="calc(100vh - 65px )">
				...
				<el-affix position="bottom" :offset="20" style="text-align: center;" v-if="EnvInfo">
					<el-button @click='saveEnv' type="primary" plain icon="el-icon-circle-check">保存编辑</el-button>
					<el-button @click='copyEnv' type="primary" plain icon="el-icon-circle-check">复制环境</el-button>
