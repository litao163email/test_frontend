<template>
	<el-row :gutter="10">
		<el-col :span="4">
			<div class="data_box">
				...
				<el-button @click="addPlan" type="primary" plain size="mini" style="width: 100%;" icon="el-icon-plus">添加测试计划</el-button>
		...
		<el-col :span="10" v-if="planInfo">
			...
			<el-row :gutter="5" style="margin-bottom: 20px;">
				...
				<el-col :span="8" style="text-align: right;">
					<el-button @click="runPlan" plain size="mini" type="primary" icon="el-icon-s-promotion">运行</el-button>
			...
			<el-scrollbar height="calc(100vh - 210px)">
				<el-table :data="scents" row-key="id" style="width: 100%;margin-bottom: 10px;" :show-header="false">
					<el-table-column>
						<template #default="scope">
							<span class="el-icon-s-help" style="color: #0044aa;font-weight: bold;font-size: 14px;">{{ '测试场景' + (scope.$index+1) + ': ' }}</span>
				...
				<el-button @click="drawer = true" plain icon="el-icon-plus" size="mini" type="primary">添加测试场景</el-button>
			</el-scrollbar>
		</el-col>
		<el-col :span="10">
			...
			<el-scrollbar height="calc(100vh - 380px)">
				<el-table :data="records" class="table-style" size="mini">
	...
	<el-drawer v-model="drawer" direction="rtl" size="20%" :show-close="false">
		<template #title><b style="color: #000000;">添加测试流程</b></template>
		<div class="select_content">
			<el-table ref="addRef" @selection-change="selectTable" size="mini" :data="Scents2" tooltip-effect="dark" style="width: 100%">
		...
		<div style="margin: 10px; text-align: center;">
			<el-tooltip class="item" effect="dark" content="添加选中测试流程到任务中" placement="top-start">
				<el-button @click="addScentToPlan" plain type="primary" size="mini">确认添加</el-button>
			</el-tooltip>
